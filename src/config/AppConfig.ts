...
export class AppConfig {
   ...
   */
  static commonUrl =
    import.meta.env.VITE_APP_COMMON_URL || 'https://www.holdhopecloud.com/'
   ...
   */
  static staticUrl =
    import.meta.env.VITE_APP_STATIC_URL || 'https://static.holdhopecloud.com/'

  /**
   * # 公共服务API地址 💡 环境变量请包含协议头
   */
  static commonApiUrl =
    import.meta.env.VITE_APP_COMMON_API_URL || 'https://sso.holdhopecloud.com/'
